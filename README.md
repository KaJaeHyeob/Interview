...
이러한 경험들을 바탕으로 LG CNS에 입사하여, 고객사 맞춤형 IT 서비스를 제공하는 테크 매니저가 되고 싶습니다. 감사합니다.    
```
...
저는 SI/SM 업무를 담당하면서 고객사의 요청에 따라 개발 및 유지보수도 하고, 스마트팩토리, RPA 등 자체 솔루션을 활용한 선제적인 비즈니스 제안도 수행하면서 여러 기술 역량을 쌓아 최종적으로 테크 매니저가 되는 게 목표입니다.    
이전 직장이 고객사 30여 곳의 SI/SM 업무를 담당한다는 점에서 제 목표를 이루기에 적합한 곳이라 생각했고, 기술 역량도 차근차근 쌓아가면서 보람도 느꼈습니다. 하지만, R&D 경쟁력이 다소 약하고 미래 먹거리를 발굴하려는 도전 및 혁신이 없다는 점에서 저의 최종 목표인 테크 매니저가 될 수는 없겠다고 생각이 들어 이직을 결심하게 되었습니다.    
## 만약, 합격했는데 여기도 똑같다면 또 이직하실 건가요?    
제가 사실 이게 맘에 안 든다 저게 맘에 안 든다 해서 바로 포기하진 않고, 오히려 해결책을 찾아내려 매달리는 성격입니다.    
미래 먹거리에 대한 고민 때문에 IT 트렌드나 동향을 파악하려 애썼고, 팀원분들과 함께 신사업 또는 신기술 개발 아이디어를 작성하여 정기 웨비나나 아이디어 공모가 있을 때마다 제출했습니다. 그런데 이게 피드백도 못 받는 채로 무시되는 게 반복되다 보니까 어쩔 수 없이 결국 이직을 결심하게 되었습니다.    
LG CNS에서도 어느 순간 미래 먹거리에 대한 고민이 생겨난다면 똑같이 이를 해결하기 위해 열심히 노력할 것입니다. 하지만, 노력이 소용없다는 생각이 드는 순간이 온다면 같이 도태되지 않기 위해서 이직을 결심할 수 밖에 없다고 생각합니다.    
```
