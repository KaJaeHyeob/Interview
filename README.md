...
- 안녕하십니까, LG CNS IT서비스 부문에 지원한 가재협입니다.    
저에게는 어떠한 서비스가 필요할지 기획하고 개발할 수 있는 능력을 갖추는 것이 배움의 큰 즐거움입니다. 따라서, 폭넓은 고객층과 도전적인 기술 개발력을 가진 LG CNS는 제가 성장하기에 가장 적합한 곳이라고 생각되어 지원하게 되었습니다.    
관련 역량을 쌓기 위해 통계학과 컴퓨터공학을 복수전공하며 전반적인 CS 지식과 프로그래밍 및 빅데이터 분석 역량을 쌓았고, 타 IT 서비스 기업에서 일하며 ERP 컨설팅 및 SAP BC 경험을 쌓았습니다.    
이러한 경험들을 바탕으로 LG CNS에 입사하여, 고객사 맞춤형 IT 서비스를 제공하는 Tech-매니저가 되고 싶습니다.
...
#### 응용    
```
이직을 결심하게 된 결정적인 이유는 미래 먹거리에 대한 고민 때문입니다.    
