...
#### 예시    
```
비업무적 지시 또는 법에 저촉되는 사항이라면 문제가 더 커지기 전에 상급자와의 상담을 통해 의사를 결정할 것 같습니다.
하지만, 업무적 지시의 경우라면 신입사원이 상사분들에 비해 역량 및 이해도가 떨어지므로 부당함에 대한 가치 판단이 서툴 것이라고 생각합니다.    
...
다만, ~ 부분은 지원하는 기업의 ~한 슬로건과 약간 어긋난다고 생각되므로 ~ 같이 바꾸면 어떨지 여쭤봅니다.    
```
...
#### 예시    
```
이직(퇴사)을 결심한 데에는 크게 두 가지 이유가 있습니다.
첫째는 미래 먹거리에 대한 고민 때문입니다.    
저는 SM/SI 업무를 담당하면서 고객사의 요청에 따라 개발 및 유지보수도 하고, 스마트팩토리, RPA 등 자체 솔루션을 활용한 선제적인 비즈니스 제안도 하면서 여러 기술 역량을 키운 후, 최종적으로 테크 매니저가 되는 게 목표입니다. 그러한 점에서 90여개 그룹 계열사의 IT를 담당하던 이전 직장은 제 목표를 이루기에 적합한 곳이라고 생각했고, 기술 역량을 차근차근 쌓아가면서 보람도 느꼈습니다. 하지만, 이전 직장에선 너무 운영적인 측면에만 … 미래 먹거리를 발굴하려는 도전 및 혁신이 없다는 점에서 저의 최종 목표인 테크 매니저가 될 수는 없겠다고 생각이 들어 이직을 결심하게 되었습니다.    
```
...
1분 자기소개
	안녕하십니까. 현대아이티앤이에 지원한 가재협입니다.
저는 빅데이터 기반 솔루션에 관심이 있습니다. 현대백화점그룹의 다방면 산업으로부터 방대한 양의 빅데이터가 추출될 것입니다. 이 빅데이터에 대한 분석 방향을 제시하고 고객에게 필요한 서비스를 제공하는 것은 필수적인 업무라고 생각합니다.
저는 이에 대한 역량을 쌓기 위해 통계학과 컴퓨터공학을 복수전공하며, AI 활용 빅데이터 프로젝트, 웹 서비스 개발 프로젝트 등을 진행하여 전문성을 키웠습니다.
이러한 경험들을 바탕으로 현대아이티앤이에 입사하여 챗봇, 스마트 스토어 등의 첨단 IT 기술에 우수한 고객 맞춤 서비스를 이루고 싶어 지원하게 되었습니다. 감사합니다.
	안녕하십니까. 롯데정보통신에 지원한 가재협입니다.
저는 빅데이터 기반 솔루션 플랫폼에 관심이 있습니다. 서비스의 높은 고객 만족도를 위해서는 빅데이터 분석을 통한 사용자 최적화와 효율 극대화가 핵심이라고 생각합니다.
저는 이에 대한 역량을 쌓기 위해 통계학과 컴퓨터공학을 복수전공하며, 빅데이터 시각화 웹 서비스 개발, DACON, Kaggle 등의 빅데이터 분석 대회를 진행하여 전문성을 키웠습니다.
이러한 경험들을 바탕으로 롯데정보통신에 입사하여 롯데그룹의 다방면 서비스로부터 발생되는 빅데이터를 활용해 서비스 최적화를 달성하게 해주는 애플리케이션을 개발하고 싶어 지원하게 되었습니다. 감사합니다.
	안녕하십니까. 한화큐셀에 지원한 가재협입니다.
저는 빅데이터 기반 솔루션 플랫폼에 관심이 있습니다. 한화큐셀의 태양광 기술 운용 및 전력 판매, 유통 과정에서 방대한 양의 빅데이터가 추출될 것이고, 이 빅데이터를 분석해 서비스를 최적화하는 것은 필수적인 업무라고 생각합니다.
저는 이에 대한 역량을 쌓기 위해 통계학과 컴퓨터공학을 복수전공하며, 빅데이터 시각화 웹 서비스 개발, DACON, Kaggle 등의 빅데이터 분석 대회를 진행하여 전문성을 키웠습니다.
이러한 경험들을 바탕으로 한화큐셀에 입사하여 클라우드 개발에 참여하고 빅데이터 분석을 통해 서비스 최적화를 달성하게 해주는 애플리케이션을 개발하고 싶어 지원하게 되었습니다. 감사합니다.


회사, 직무 지원 이유 (회사의 미션, 비젼)
	챗봇, 스마트 스토어 등의 첨단 IT 기술에 우수한 고객 맞춤 서비스를 이루고 싶어 지원하게 되었습니다.
현재 많은 기업들이 앱과 웹을 중심으로 고객 서비스를 제공하고 있으며, 곧 더 나아가 챗봇, 스마트 스토어 등의 AI 활용 서비스가 시장을 주도할 것입니다. 저는 이러한 변화에 발맞춰 현대백화점그룹이 가진 빅데이터를 적극 활용하여 가치 창출에 나설 것입니다.
고객의 주문 품목, 주문 시간대, 주문 간격 등 다양한 데이터 사이의 연관성을 분석하고 고객에게 필요할 것이라고 예상되는 서비스를 개발함으로써 고객 만족도를 크게 향상시킬 것입니다.
이와 같은 만족도 높은 서비스들이 모여 최종적으로 현대백화점그룹만의 독자적인 서비스 플랫폼을 구축하는 것이 제 목표입니다.
	현대백화점그룹의 2020년도 미션은 ‘고객을 행복하게, 세상을 풍요롭게’이고, 이를 통해 ‘고객에게 신뢰받는 기업’이라는 비젼을 달성하고자 합니다.
저는 이를 위해 챗봇, 스마트 스토어 등의 첨단 IT 기술에 우수한 고객 맞춤 서비스를 이루고 싶어 지원하게 되었습니다
현재 많은 기업들이 앱과 웹을 중심으로 고객 서비스를 제공하고 있으며, 곧 더 나아가 챗봇, 스마트 스토어 등의 AI 활용서비스가 시장을 주도할 것입니다. 저는 이러한 변화에 발맞춰 현대백화점그룹이 가진 빅데이터를 적극 활용하여 가치 창출에 나설 것입니다.
고객의 주문 품목, 주문 시간대, 주문 간격 등 다양한 데이터 사이의 연관성을 분석하고 고객에게 필요할 것이라고 예상되는 서비스를 개발함으로써 고객 만족도를 크게 향상시킬 것입니다.
이와 같은 만족도 높은 서비스들이 모여 최종적으로 현대백화점그룹만의 독자적인 서비스 플랫폼을 구축하는 것이 제 목표입니다.
...
	클라우드 개발에 참여하여 빅데이터 분석을 통해 서비스 최적화를 가능하게 해주는 애플리케이션을 개발하고자 지원하게 되었습니다.
현재 한화큐셀은 에너지 저장 시스템 ESS와 홈 에너지 관리 시스템 HEMS의 성공적인 개발을 통해 분산 전력의 모집저장 및 판매가 가능해졌습니다. 따라서, 전력 유통 사업에 관심을 갖고 있다고 생각합니다. 전력은 무형의 자원이긴 하지만, 결국에는 유통 사업에 포함되므로 유명한 성공 사례인 아마존의 유통 자동화 시스템을 참고하여 한화큐셀에도 최종적으로 이러한 유통 자동화 시스템을 적용시키고 싶습니다.
