...
> 만약 LG CNS에서도 미래 먹거리에 대한 고민이 생겨나기 시작한다면, 그때도 똑같이 이를 해결하기 위해 열심히 노력할 것입니다.    
> 하지만 그럼에도 불구하고, 개선되는 사항이 없고 노력이 소용없다는 생각이 드는 순간이 오면 같이 도태되지 않기 위해서라도 이직을 결심할 수 밖에 없다고 생각합니다.    
> #### 어떤 아이디어였는지 물어봐도 될까요?    
> LG CNS와 마찬가지로 이전 직장도 스마트팩토리나 스마트물류에 관심을 갖고 개발을 진행 중인데, 사실 후발주자이다 보니까 경쟁력도 약하고 사업 수주도 잘 이루어지지 않는 편입니다. 따라서, 해당 부분에 대해 경쟁력을 강화시키는 방안으로 독자적인 OT 보안 솔루션을 개발하거나 OT 보안 인증을 취득한 업체와 협약을 체결하는 아이디어를 제시했습니다.    
