...
#### 예시    
```
비업무적 지시 또는 법에 저촉되는 사항이라면 갈등 상황이 더 커지기 전에 상급자와의 상담을 통해 의사를 결정할 것 같습니다.
...
저는 SM/SI 업무를 담당하면서 고객사의 요청에 따라 개발 및 유지보수도 하고, 스마트팩토리, RPA 등 자체 솔루션을 활용한 선제적인 비즈니스 제안도 하면서 여러 기술 역량을 쌓아 최종적으로 테크 매니저가 되는 게 목표입니다. 그러한 점에서 90여개 그룹 계열사의 IT를 담당하던 이전 직장은 제 목표를 이루기에 적합한 곳이라고 생각했고, 기술 역량을 차근차근 쌓아가면서 보람도 느꼈습니다. 하지만, 이전 직장에선 너무 운영적인 측면에만 … 미래 먹거리를 발굴하려는 도전 및 혁신이 없다는 점에서 저의 최종 목표인 테크 매니저가 될 수는 없겠다고 생각이 들어 이직을 결심하게 되었습니다.    
```
